...
export const directorTemplate = (name: string) => {
    const title = 'Director Status Pending';
    const content = `
        <h2 style="color: ${COLORS.text}; font-size: 20px; margin-top: 0; margin-bottom: 20px; font-weight: 700;">Initiating Director Access</h2>
