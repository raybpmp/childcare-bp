...
import { StackedTabs } from '@/components/ui/StackedTabs';
            ...
            <section className="py-12 md:py-20">
                ...
                <div className="text-center mb-8 px-4">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 mb-3 md:text-4xl">
                        The Complete Childcare Business Plan
                    </h1>
                ...
                <div className="lg:hidden">
                    <StackedTabs
                        ...
                        getTabLabel={(tier) => tier.name.replace('The ', '')}
                        defaultValue="The Director"
                        tabListLabel="Select a membership plan"
                        cardsId="pricing-cards-mobile"
                    />
                </div>

                {/* Desktop: 3-column grid */}
                <div className="hidden lg:block px-4 max-w-7xl mx-auto">
                        ...
                        {tiers.map((tier, index) => (
                            <motion.div
                                ...
                                className={`
                                    ...
                                    ${tier.featured
                                        ? 'bg-gray-900 text-white shadow-2xl -mt-4 mb-4 z-10'
                                        : 'glass-panel'
                                    }
                                `}
                            >
