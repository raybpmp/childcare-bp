...
exports.launchpadTemplate = void 0;
const layout_1 = require("../layout");
const launchpadTemplate = (name) => {
    const title = 'Application Received';
    const content = `
        <h2 style="color: ${layout_1.COLORS.text}; font-size: 20px; margin-top: 0; margin-bottom: 20px; font-weight: 700;">Welcome to the Application Process</h2>
        ...
        <div style="margin: 30px 0; padding: 25px; background-color: ${layout_1.COLORS.successBg}; border: 1px solid #bbf7d0; border-radius: 12px;">
            <h3 style="margin-top: 0; color: ${layout_1.COLORS.success}; font-size: 17px; font-weight: 700;">What happens next?</h3>
...
exports.launchpadTemplate = launchpadTemplate;
