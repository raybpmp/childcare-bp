                        ...
                        <div className="glass-panel w-full max-w-lg rounded-3xl p-8 shadow-2xl pointer-events-auto relative overflow-hidden">
                            ...
                            <div className="flex bg-gray-100/50 p-1 rounded-full mb-8 relative">
                                ...
                                <button
                                    ...
                                    className={`flex-1 relative z-10 py-2.5 text-sm font-medium rounded-full transition-colors ${activeTab === 'consulting' ? 'text-brand-700' : 'text-gray-500 hover:text-gray-700'}`}
                                >
                                    Own a Daycare
                                </button>
                            </div>
