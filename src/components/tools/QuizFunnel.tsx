            ...
            <div className="max-w-md mx-auto px-4">
                <Card className="glass-panel overflow-hidden">
                    <CardContent className="p-6 space-y-6">
                        ...
                        >
                            <span className="text-5xl mb-4 block">💰</span>
                            <p className="text-sm text-gray-500 mb-2">YOUR REVENUE POTENTIAL IN {stateInfo?.name.toUpperCase()}</p>
                            <div className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent">
                                ${min.toLocaleString()} - ${max.toLocaleString()}
                            </div>
                            <p className="text-lg text-gray-600 mt-2">per year</p>
                        </motion.div>

                        <div className="p-4 rounded-xl bg-gradient-to-br from-teal-50 to-emerald-50 text-center">
                            <p className="text-gray-700">
                                Based on your answers and local {stateInfo?.name} market data
                            </p>
                        </div>

                        <div className="p-4 rounded-xl bg-white/60 border border-teal-100">
                            <p className="text-center text-teal-800 font-medium">
                                ✨ This is absolutely achievable with the right plan.
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-xs text-center text-gray-500">
                                ✉️ Check your email — we sent your detailed breakdown.
                            </p>
                        </div>
                    </CardContent>
                </Card>
...
// Determine total quiz steps dynamically based on state and business type
const getTotalSteps = () => {
    let steps = 10; // Base: Q1-Q6 (6) + Q9-Q10 (2) + email (1) + results (1)

    // For home-based with large license support, add license type question
    if (answers.businessType === 'home' && stateInfo?.hasLargeLicense) {
        steps += 1; // Add license type question
    }
...
// QUIZ QUESTIONS - dynamically render based on step and previous answers
return (
    <div className="max-w-md mx-auto px-4">
        <Card className="glass-panel">
            <CardContent className="p-6 space-y-6">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {/* HOME PATH: Q8H - Capacity Slider */}
                        {step === (stateInfo?.hasLargeLicense ? 7 : 6) && answers.businessType === 'home' && (
                            <div>
                                <h2 className="text-xl font-bold text-gray-900 mb-4 text-center">
                                    How many children total?
                                </h2>
