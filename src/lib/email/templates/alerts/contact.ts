...
import type { ContactEmailPayload } from '../../../EmailService';

export const contactAlertTemplate = (data: ContactEmailPayload) => {
    const html = renderBaseLayout('CONTACT SUBMISSION', `
