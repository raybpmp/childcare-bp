...
exports.userResultsTemplate = void 0;
const layout_1 = require("../layout");
const userResultsTemplate = (data) => {
    var _a;
    const html = (0, layout_1.renderBaseLayout)('Your Results Are In! 🎉', `
    ...
    return {
        ...
        text: `Hi! Your estimated revenue potential is $${(_a = data.revenuePotential) === null || _a === void 0 ? void 0 : _a.toLocaleString()}. View the full email for details.`,
        html
    };
};
exports.userResultsTemplate = userResultsTemplate;
