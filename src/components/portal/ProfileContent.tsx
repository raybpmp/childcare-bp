    ...
    return (
        <div className="max-w-4xl mx-auto space-y-4">
            <div>
                ...
                <p className="pro-text-meta">Manage your profile information and preferences.</p>
            </div>
                ...
                <div className="md:col-span-1 pro-card glass-panel shadow-sm">
                    <div className="flex flex-col items-center justify-center space-y-3">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Verified Member</p>
                        </div>
                    </div>
                </div>
