...
exports.ceoTemplate = void 0;
const layout_1 = require("../layout");
const ceoTemplate = (name) => {
    const title = 'CEO Circle Entrance';
    const content = `
        <h2 style="color: ${layout_1.COLORS.text}; font-size: 20px; margin-top: 0; margin-bottom: 20px; font-weight: 700;">Welcome to the CEO Circle</h2>
...
exports.ceoTemplate = ceoTemplate;
